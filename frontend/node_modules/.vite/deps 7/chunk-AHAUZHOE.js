...
init_clsx_m();
init_useEventCallback();
var useEnhancedEffect = typeof window === "undefined" ? React6.useEffect : React6.useLayoutEffect;
function Ripple(props) {
  ...
  var _React$useState = React6.useState(false), leaving = _React$useState[0], setLeaving = _React$useState[1];
...
var TouchRipple = React7.forwardRef(function TouchRipple2(props, ref) {
  ...
  var _React$useState = React7.useState([]), ripples = _React$useState[0], setRipples = _React$useState[1];
  var nextKey = React7.useRef(0);
  var rippleCallback = React7.useRef(null);
  ...
  var ignoringMouseDown = React7.useRef(false);
  var startTimer = React7.useRef(null);
  var startTimerCommit = React7.useRef(null);
  var container = React7.useRef(null);
  React7.useEffect(function() {
    return function() {
      clearTimeout(startTimer.current);
    };
  }, []);
  var startCommit = React7.useCallback(function(params) {
    ...
    setRipples(function(oldRipples) {
      return [].concat(_toConsumableArray(oldRipples), [React7.createElement(Ripple_default, {
        key: nextKey.current,
        classes,
        timeout: DURATION,
        pulsate: pulsate2,
  ...
  var start = React7.useCallback(function() {
  ...
  var pulsate = React7.useCallback(function() {
    start({}, {
      pulsate: true
    });
  }, [start]);
  var stop = React7.useCallback(function(event, cb) {
    clearTimeout(startTimer.current);
  ...
  return React7.createElement("span", _extends({
    className: clsx_m_default(classes.root, className),
    ref: container
  }, other), React7.createElement(TransitionGroup_default, {
    component: null,
    exit: true
  }, ripples));
});
...
var TouchRipple_default = withStyles_default(styles3, {
  flip: false,
  name: "MuiTouchRipple"
})(React7.memo(TouchRipple));
...
var ButtonBase = React8.forwardRef(function ButtonBase2(props, ref) {
  ...
  var buttonRef = React8.useRef(null);
  function getButtonNode() {
    return ReactDOM2.findDOMNode(buttonRef.current);
  }
  var rippleRef = React8.useRef(null);
  var _React$useState = React8.useState(false), focusVisible = _React$useState[0], setFocusVisible = _React$useState[1];
  ...
  React8.useImperativeHandle(action, function() {
    return {
  ...
  var keydownRef = React8.useRef(false);
  ...
  var _React$useState2 = React8.useState(false), mountedState = _React$useState2[0], setMountedState = _React$useState2[1];
  React8.useEffect(function() {
  ...
  return React8.createElement(ComponentProp, _extends({
    ...
    React8.createElement(TouchRipple_default, _extends({
      ref: rippleRef,
      center: centerRipple
    }, TouchRippleProps))
  ) : null);
...
var ButtonBase_default = withStyles_default(styles5, {
  name: "MuiButtonBase"
})(ButtonBase);
...
var IconButton = React9.forwardRef(function IconButton2(props, ref) {
...
true ? IconButton.propTypes = {
   ...
   * The icon element.
   */
  children: chainPropTypes(import_prop_types9.default.node, function(props) {
    var found = React9.Children.toArray(props.children).some(function(child) {
      return React9.isValidElement(child) && child.props.onClick;
    });
    if (found) {
   ...
   */
  color: import_prop_types9.default.oneOf(["default", "inherit", "primary", "secondary"]),
  /**
   ...
   * size and shape).
   */
  edge: import_prop_types9.default.oneOf(["start", "end", false]),
  /**
   * The size of the button.
   * `small` is equivalent to the dense button styling.
   */
  size: import_prop_types9.default.oneOf(["small", "medium"])
} : void 0;
var IconButton_default = withStyles_default(styles6, {
  name: "MuiIconButton"
})(IconButton);
...
//# sourceMappingURL=chunk-AHAUZHOE.js.map
