...
import {
  ...
  CardTitle_default,
  Card_default
} from "./chunk-WMGW2AZK.js";
import {
  divWithClassName_default
} from "./chunk-UBCSFDMP.js";
import {
  ENTERING,
  EXITING,
  hasClass
...
import {
  Button_default
} from "./chunk-QTAO77YZ.js";
import {
  NavItem_default,
  Nav_default,
  Nav_default2
} from "./chunk-AWKXV2P2.js";
import {
  Anchor_default,
  NavLink_default,
  TabContext_default,
...
import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-DHDOL6FB.js";
import "./chunk-IXRMZ5SK.js";
import "./chunk-47JAI3MH.js";
import "./chunk-A5WB65OI.js";
import {
  Container_default
} from "./chunk-GG6ZZB3S.js";
import {
  DEFAULT_BREAKPOINTS,
...
var DropdownButton = React23.forwardRef(({
  title,
  children,
  bsPrefix,
  rootCloseEvent,
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime24.jsxs)(Dropdown_default, {
  ref,
  ...props,
  children: [(0, import_jsx_runtime23.jsx)(DropdownToggle_default, {
    id,
    href,
    size: size2,
    variant,
    ...
    children: title
  }), (0, import_jsx_runtime23.jsx)(DropdownMenu_default, {
    role: menuRole,
...
var FigureImage = React25.forwardRef(({
  className,
  fluid = true,
  ...props
...
var FigureCaption = React26.forwardRef(({
  className,
  bsPrefix,
...
var Feedback = React28.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    as: Component2 = "div",
    className,
    ...
    tooltip = false,
    ...props
  }, ref) => (0, import_jsx_runtime29.jsx)(Component2, {
    ...props,
    ref,
...
var FormContext = React29.createContext({});
var FormContext_default = FormContext;

// node_modules/react-bootstrap/esm/FormCheckInput.js
var import_jsx_runtime30 = __toESM(require_jsx_runtime());
var FormCheckInput = React30.forwardRef(({
  id,
  bsPrefix,
  className,
  type = "checkbox",
...
var FormCheckLabel = React31.forwardRef(({
  bsPrefix,
  className,
  htmlFor,
  ...props
  ...
  return (0, import_jsx_runtime31.jsx)("label", {
    ...props,
    ref,
...
var FormCheck = React32.forwardRef(({
  id,
  bsPrefix,
  bsSwitchPrefix,
  inline = false,
  ...
  const input = (0, import_jsx_runtime32.jsx)(FormCheckInput_default, {
    ...props,
  ...
  return (0, import_jsx_runtime32.jsx)(FormContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime32.jsx)("div", {
      ...
      children: children || (0, import_jsx_runtime34.jsxs)(import_jsx_runtime33.Fragment, {
        children: [input, hasLabel && (0, import_jsx_runtime32.jsx)(FormCheckLabel_default, {
          title,
          children: label
        }), feedback && (0, import_jsx_runtime32.jsx)(Feedback_default, {
          type: feedbackType,
...
var FormControl = React33.forwardRef(({
  ...
  return (0, import_jsx_runtime35.jsx)(Component2, {
    ...
    readOnly,
    id: id || controlId,
    className: (0, import_classnames28.default)(className, plaintext ? `${bsPrefix}-plaintext` : bsPrefix, size2 && `${bsPrefix}-${size2}`, type === "color" && `${bsPrefix}-color`, isValid && "is-valid", isInvalid && "is-invalid")
  });
});
...
var FormFloating = React34.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var FormGroup = React35.forwardRef(({
  controlId,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
  ...props
...
var FormLabel = React36.forwardRef(({
  ...
  htmlFor = htmlFor || controlId;
  if (column)
    return (0, import_jsx_runtime38.jsx)(Col_default, {
      ref,
      as: "label",
      className: classes,
      htmlFor,
  ...
  return (
    ...
    (0, import_jsx_runtime38.jsx)(Component2, {
      ref,
      className: classes,
      htmlFor,
      ...props
...
var FormRange = React37.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
  ...
  return (0, import_jsx_runtime39.jsx)("input", {
    ...props,
    type: "range",
    ref,
...
var FormSelect = React38.forwardRef(({
  bsPrefix,
  size: size2,
  htmlSize,
  className,
  ...
  return (0, import_jsx_runtime40.jsx)("select", {
    ...props,
    size: htmlSize,
    ref,
...
var FormText = React39.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var Switch = React40.forwardRef((props, ref) => (0, import_jsx_runtime42.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React41.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
  ...
  bsPrefix = useBootstrapPrefix(bsPrefix, "form-floating");
  return (0, import_jsx_runtime44.jsxs)(FormGroup_default, {
    ref,
    className: (0, import_classnames34.default)(className, bsPrefix),
    controlId,
    ...props,
    children: [children, (0, import_jsx_runtime43.jsx)("label", {
      htmlFor: controlId,
      children: label
    })]
  });
...
var ModalBody = React47.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalDialog = React48.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
...
var ModalHeader = React50.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var ModalTitle = React51.forwardRef(({
  className,
  bsPrefix,
...
var Modal = React52.forwardRef(({
  ...
  const renderBackdrop = (0, import_react18.useCallback)((backdropProps) => (0, import_jsx_runtime55.jsx)("div", {
    ...backdropProps,
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime65.jsxs)(import_jsx_runtime64.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react23.cloneElement)(children, triggerProps), (0, import_jsx_runtime63.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var Pagination = React62.forwardRef(({
  ...
  return (0, import_jsx_runtime68.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames52.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames53.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React63.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime69.jsx)(Button_default, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
var Spinner = React68.forwardRef(({
  ...
  return (0, import_jsx_runtime74.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames57.default)(className, bsSpinnerPrefix, size2 && `${bsSpinnerPrefix}-${size2}`, variant && `text-${variant}`)
  });
});
...
var SplitButton = React69.forwardRef(({
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime76.jsxs)(Dropdown_default, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime75.jsx)(Button_default, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime75.jsx)(Dropdown_default.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
  ...
  }), (0, import_jsx_runtime75.jsx)(Dropdown_default.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip,
...
var TabContent = React74.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ToastBody = React81.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ToggleButton = React84.forwardRef(({
  ...
  return (0, import_jsx_runtime94.jsxs)(import_jsx_runtime93.Fragment, {
    children: [(0, import_jsx_runtime92.jsx)("input", {
      ...
      id
    }), (0, import_jsx_runtime92.jsx)(Button_default, {
      ...props,
      ref,
