import {
  Alert_default,
  Close_default
} from "./chunk-F4FEPGRB.js";
import {
  Rating_default,
  chainPropTypes
} from "./chunk-4ROSYH3D.js";
import {
  Avatar_default,
  Chip_default,
  Collapse_default,
...
var AlertTitle = React.forwardRef(function AlertTitle2(props, ref) {
...
var AlertTitle_default = withStyles_default(styles, {
  name: "MuiAlertTitle"
})(AlertTitle);
...
function useAutocomplete(props) {
  ...
  var setHighlightedIndex = useEventCallback(function(_ref22) {
...
function DisablePortal(props) {
  ...
  return React4.createElement("div", other);
}
var _ref = React4.createElement(Close_default, {
  fontSize: "small"
});
var _ref2 = React4.createElement(ArrowDropDown_default, null);
var Autocomplete = React4.forwardRef(function Autocomplete2(props, ref) {
  ...
  if (multiple && value.length > 0) {
    ...
    if (renderTags) {
      ...
      startAdornment = value.map(function(option, index) {
        return React4.createElement(Chip_default, _extends({
  ...
  if (limitTags > -1 && Array.isArray(startAdornment)) {
    ...
    if (!focused && more > 0) {
      ...
      startAdornment.push(React4.createElement("span", {
  ...
  var defaultRenderGroup = function defaultRenderGroup2(params) {
    return React4.createElement("li", {
      key: params.key
    }, React4.createElement(ListSubheader_default, {
      className: classes.groupLabel,
      component: "div"
    }, params.group), React4.createElement("ul", {
  ...
  var renderListOption = function renderListOption2(option, index) {
    ...
    return React4.createElement("li", _extends({}, optionProps, {
  ...
  return React4.createElement(React4.Fragment, null, React4.createElement("div", _extends({
    ref,
    ...
    InputProps: {
      ...
      startAdornment,
      endAdornment: React4.createElement("div", {
        className: classes.endAdornment
      }, hasClearIcon ? React4.createElement(IconButton_default, _extends({}, getClearProps(), {
        "aria-label": clearText,
        title: clearText,
        className: clsx_m_default(classes.clearIndicator, dirty && classes.clearIndicatorDirty)
      }), closeIcon) : null, hasPopupIcon ? React4.createElement(IconButton_default, _extends({}, getPopupIndicatorProps(), {
        disabled,
  ...
  })), popupOpen && anchorEl ? React4.createElement(PopperComponent, {
    ...
    anchorEl,
    open: true
  }, React4.createElement(PaperComponent, {
    className: classes.paper
  }, loading && groupedOptions.length === 0 ? React4.createElement("div", {
    className: classes.loading
  }, loadingText) : null, groupedOptions.length === 0 && !freeSolo && !loading ? React4.createElement("div", {
    className: classes.noOptions
  }, noOptionsText) : null, groupedOptions.length > 0 ? React4.createElement(ListboxComponent, _extends({
...
true ? Autocomplete.propTypes = {
   ...
   */
  closeIcon: import_prop_types2.default.node,
  /**
   ...
   * @returns {boolean}
   */
  getOptionSelected: import_prop_types2.default.func,
  /**
   ...
   */
  limitTags: import_prop_types2.default.number,
  /**
...
var Autocomplete_default = withStyles_default(styles3, {
...
var AvatarGroup = React5.forwardRef(function AvatarGroup2(props, ref) {
  ...
  var children = React5.Children.toArray(childrenProp).filter(function(child) {
    if (true) {
  ...
  }), extraAvatars ? React5.createElement(Avatar_default, {
...
true ? AvatarGroup.propTypes = {
   ...
   */
  max: chainPropTypes(import_prop_types3.default.number, function(props) {
    if (props.max < 2) {
...
var AvatarGroup_default = withStyles_default(styles5, {
  name: "MuiAvatarGroup"
})(AvatarGroup);
...
init_utils();
var FirstPage_default = createSvgIcon(React6.createElement("path", {
...
init_utils();
var LastPage_default = createSvgIcon(React7.createElement("path", {
...
init_utils();
var NavigateBefore_default = createSvgIcon(React8.createElement("path", {
...
init_utils();
var NavigateNext_default = createSvgIcon(React9.createElement("path", {
...
var PaginationItem = React10.forwardRef(function PaginationItem2(props, ref) {
  ...
  return type === "start-ellipsis" || type === "end-ellipsis" ? React10.createElement("div", {
    ref,
  ...
  }, "…") : React10.createElement(ButtonBase_default, _extends({
    ref,
    component,
    disabled,
  ...
  }, other), type === "page" && page, Icon ? React10.createElement(Icon, {
...
true ? PaginationItem.propTypes = {
   ...
   * The active color.
   */
  color: import_prop_types4.default.oneOf(["standard", "primary", "secondary"]),
  /**
   ...
   */
  page: import_prop_types4.default.number,
  /**
   ...
   */
  shape: import_prop_types4.default.oneOf(["round", "rounded"]),
  /**
   * The size of the pagination item.
   */
  size: import_prop_types4.default.oneOf(["small", "medium", "large"]),
  /**
   * The type of pagination item.
   */
  type: import_prop_types4.default.oneOf(["page", "first", "last", "next", "previous", "start-ellipsis", "end-ellipsis"]),
  /**
   * The pagination item variant.
   */
  variant: import_prop_types4.default.oneOf(["text", "outlined"])
} : void 0;
var PaginationItem_default = withStyles_default(styles7, {
...
var Pagination = React11.forwardRef(function Pagination2(props, ref) {
  var boundaryCount = props.boundaryCount, classes = props.classes, className = props.className, _props$color = props.color, color = _props$color === void 0 ? "standard" : _props$color, count = props.count, defaultPage = props.defaultPage, disabled = props.disabled, _props$getItemAriaLab = props.getItemAriaLabel, getItemAriaLabel = _props$getItemAriaLab === void 0 ? defaultGetAriaLabel : _props$getItemAriaLab, hideNextButton = props.hideNextButton, hidePrevButton = props.hidePrevButton, onChange = props.onChange, page = props.page, _props$renderItem = props.renderItem, renderItem = _props$renderItem === void 0 ? function(item) {
    return React11.createElement(PaginationItem_default, item);
  ...
  return React11.createElement("nav", _extends({
    "aria-label": "pagination navigation",
    className: clsx_m_default(classes.root, className),
    ref
  }, other), React11.createElement("ul", {
    className: classes.ul
  }, items.map(function(item, index) {
    return React11.createElement("li", {
      key: index
...
true ? Pagination.propTypes = {
   ...
   * @default 1
   */
  boundaryCount: import_prop_types5.default.number,
  /**
   * Override or extend the styles applied to the component.
   * See [CSS API](#css) below for more details.
   */
   ...
   * The active color.
   */
  color: import_prop_types5.default.oneOf(["primary", "secondary", "standard"]),
  /**
   * The total number of pages.
   * @default 1
   */
  count: import_prop_types5.default.number,
  /**
   * The page selected by default when the component is uncontrolled.
   * @default 1
   */
  defaultPage: import_prop_types5.default.number,
  /**
   ...
   * The current page.
   */
  page: import_prop_types5.default.number,
  /**
   * Render the item.
   *
   ...
   */
  shape: import_prop_types5.default.oneOf(["round", "rounded"]),
  /**
   ...
   * @default 1
   */
  siblingCount: import_prop_types5.default.number,
  /**
   ...
   * The variant to use.
   */
  variant: import_prop_types5.default.oneOf(["outlined", "text"])
} : void 0;
var Pagination_default = withStyles_default(styles9, {
  name: "MuiPagination"
})(Pagination);
...
var Skeleton = React12.forwardRef(function Skeleton2(props, ref) {
...
var Skeleton_default = withStyles_default(styles10, {
  name: "MuiSkeleton"
})(Skeleton);
...
var SpeedDial = React13.forwardRef(function SpeedDial2(props, ref) {
  ...
  var eventTimer = React13.useRef();
  React13.useEffect(function() {
    return function() {
      clearTimeout(eventTimer.current);
    };
  }, []);
  var focusedAction = React13.useRef(0);
  var nextItemArrowKey = React13.useRef();
  var actions = React13.useRef([]);
  actions.current = [actions.current[0]];
  var handleOwnFabRef = React13.useCallback(function(fabFef) {
  ...
  var allItems = React13.Children.toArray(childrenProp).filter(function(child) {
    if (true) {
  ...
  return React13.createElement("div", _extends({
  ...
  }, other), React13.createElement(TransitionComponent, _extends({
    in: !hidden,
    timeout: transitionDuration,
    unmountOnExit: true
  }, TransitionProps), React13.createElement(Fab_default, _extends({
    color: "primary",
    ...
    ref: handleFabRef
  }), React13.isValidElement(icon) && isMuiElement(icon, ["SpeedDialIcon"]) ? React13.cloneElement(icon, {
    open
  }) : icon)), React13.createElement("div", {
...
var SpeedDial_default = withStyles_default(styles12, {
  name: "MuiSpeedDial"
})(SpeedDial);
...
var SpeedDialAction = React14.forwardRef(function SpeedDialAction2(props, ref) {
  ...
  var _React$useState = React14.useState(tooltipOpenProp), tooltipOpen = _React$useState[0], setTooltipOpen = _React$useState[1];
  ...
  var fab = React14.createElement(Fab_default, _extends({
    size: "small",
  ...
  if (tooltipOpenProp) {
    return React14.createElement("span", _extends({
      id,
      ref,
  ...
  return React14.createElement(Tooltip_default, _extends({
    id,
    ref,
    title: tooltipTitle,
...
var SpeedDialAction_default = withStyles_default(styles14, {
...
init_utils();
var Add_default = createSvgIcon(React15.createElement("path", {
...
var SpeedDialIcon = React16.forwardRef(function SpeedDialIcon2(props, ref) {
  ...
  return React16.createElement("span", _extends({
    className: clsx_m_default(classes.root, className),
    ref
  }, other), openIconProp ? formatIcon(openIconProp, openIconClassName) : null, iconProp ? formatIcon(iconProp, iconClassName) : React16.createElement(Add_default, {
...
var SpeedDialIcon_default = withStyles_default(styles16, {
...
function useUniquePrefix() {
  var _React$useState = React17.useState(null), id = _React$useState[0], setId = _React$useState[1];
...
var TabList = React18.forwardRef(function TabList2(props, ref) {
  var childrenProp = props.children, other = _objectWithoutProperties(props, ["children"]);
  var context = useTabContext();
  if (context === null) {
    throw new TypeError("No TabContext provided");
  }
  var children = React18.Children.map(childrenProp, function(child) {
  ...
  return React18.createElement(Tabs_default, _extends({}, other, {
    ref,
    value: context.value
  }), children);
});
...
var TabPanel = React19.forwardRef(function TabPanel2(props, ref) {
...
var TabPanel_default = withStyles_default(styles18, {
  name: "MuiTabPanel"
})(TabPanel);
...
var TimelineContext = React20.createContext({});
if (true) {
...
// node_modules/@material-ui/lab/esm/Timeline/Timeline.js
var styles20 = function styles21() {
  return {
    /* Styles applied to the root element. */
    root: {
      display: "flex",
...
var Timeline = React21.forwardRef(function Timeline2(props, ref) {
  ...
  return React21.createElement(TimelineContext_default.Provider, {
    value: {
      align
    }
  }, React21.createElement("ul", _extends({
...
var Timeline_default = withStyles_default(styles20, {
  name: "MuiTimeline"
})(Timeline);
...
var TimelineConnector = React22.forwardRef(function TimelineConnector2(props, ref) {
  var classes = props.classes, className = props.className, other = _objectWithoutProperties(props, ["classes", "className"]);
...
var TimelineConnector_default = withStyles_default(styles22, {
...
var TimelineItemContext = React23.createContext({});
if (true) {
...
// node_modules/@material-ui/lab/esm/TimelineContent/TimelineContent.js
var styles24 = function styles25() {
  return {
    /* Styles applied to the root element. */
    root: {
      flex: 1,
...
var TimelineContent = React24.forwardRef(function TimelineContent2(props, ref) {
  var classes = props.classes, className = props.className, other = _objectWithoutProperties(props, ["classes", "className"]);
  var _React$useContext = React24.useContext(TimelineContext_default), _React$useContext$ali = _React$useContext.align, align = _React$useContext$ali === void 0 ? "left" : _React$useContext$ali;
  var _React$useContext2 = React24.useContext(TimelineItemContext_default), _React$useContext2$cl = _React$useContext2.classes, contextClasses = _React$useContext2$cl === void 0 ? {} : _React$useContext2$cl;
...
var TimelineContent_default = withStyles_default(styles24, {
...
var TimelineDot = React25.forwardRef(function TimelineDot2(props, ref) {
  ...
  return React25.createElement("span", _extends({
...
var TimelineDot_default = withStyles_default(styles26, {
  name: "MuiTimelineDot"
})(TimelineDot);
...
init_clsx_m();
init_utils();
var styles28 = function styles29() {
  return {
    /* Styles applied to the root element. */
    root: {
      listStyle: "none",
...
var TimelineItem = React26.forwardRef(function TimelineItem2(props, ref) {
  var classes = props.classes, className = props.className, other = _objectWithoutProperties(props, ["classes", "className"]);
  ...
  return React26.createElement(TimelineItemContext_default.Provider, {
    value: {
      classes: {
  ...
  }, React26.createElement("li", _extends({
...
var TimelineItem_default = withStyles_default(styles28, {
...
init_clsx_m();
init_utils();
var styles30 = function styles31() {
  return {
    /* Styles applied to the root element. */
    root: {
      padding: "6px 16px",
...
var TimelineOppositeContent = React27.forwardRef(function TimelineOppositeContent2(props, ref) {
  var classes = props.classes, className = props.className, other = _objectWithoutProperties(props, ["classes", "className"]);
  var _React$useContext = React27.useContext(TimelineContext_default), _React$useContext$ali = _React$useContext.align, align = _React$useContext$ali === void 0 ? "left" : _React$useContext$ali;
  var _React$useContext2 = React27.useContext(TimelineItemContext_default), _React$useContext2$cl = _React$useContext2.classes, contextClasses = _React$useContext2$cl === void 0 ? {} : _React$useContext2$cl;
...
var TimelineOppositeContent_default = withStyles_default(styles30, {
...
init_clsx_m();
var styles32 = function styles33() {
  return {
    /* Styles applied to the root element. */
    root: {
      display: "flex",
...
var TimelineSeparator = React28.forwardRef(function TimelineSeparator2(props, ref) {
  var classes = props.classes, className = props.className, other = _objectWithoutProperties(props, ["classes", "className"]);
...
var TimelineSeparator_default = withStyles_default(styles32, {
...
var ToggleButton = React29.forwardRef(function ToggleButton2(props, ref) {
  ...
  }, other), React29.createElement("span", {
...
var ToggleButton_default = withStyles_default(styles34, {
...
var ToggleButtonGroup = React30.forwardRef(function ToggleButton3(props, ref) {
...
var ToggleButtonGroup_default = withStyles_default(styles36, {
...
var TreeViewContext = React31.createContext({});
if (true) {
...
var TreeItem = React32.forwardRef(function TreeItem2(props, ref) {
  ...
  React32.useEffect(function() {
    if (addNodeToNodeMap) {
      ...
      React32.Children.forEach(children, function(child) {
        if (React32.isValidElement(child) && child.props.nodeId) {
  ...
  return React32.createElement("li", _extends({
  ...
  }, icon), React32.createElement(Typography_default, {
    onClick: onLabelClick,
    component: "div",
    className: classes.label
  }, label)), children && React32.createElement(TransitionComponent, _extends({
    unmountOnExit: true,
...
var TreeItem_default = withStyles_default(styles38, {
  name: "MuiTreeItem"
})(TreeItem);
...
var TreeView = React33.forwardRef(function TreeView2(props, ref) {
  ...
  var _React$useState = React33.useState(null), tabbable = _React$useState[0], setTabbable = _React$useState[1];
  var _React$useState2 = React33.useState(null), focusedNodeId = _React$useState2[0], setFocusedNodeId = _React$useState2[1];
  var nodeMap = React33.useRef({});
  var firstCharMap = React33.useRef({});
  var visibleNodes = React33.useRef([]);
  var _useControlled = useControlled({
  ...
  var isExpanded = React33.useCallback(function(id) {
    return Array.isArray(expanded) ? expanded.indexOf(id) !== -1 : false;
  }, [expanded]);
  var isSelected = React33.useCallback(function(id) {
  ...
  var lastSelectedNode = React33.useRef(null);
  var lastSelectionWasRange = React33.useRef(false);
  var currentRangeSelection = React33.useRef([]);
  ...
  var getNodesToRemove = React33.useCallback(function(id) {
    var map = nodeMap.current[id];
    var nodes = [];
    if (map) {
      nodes.push(id);
  ...
  var cleanUpFirstCharMap = React33.useCallback(function(nodes) {
  ...
  var removeNodeFromNodeMap = React33.useCallback(function(id) {
  ...
  var prevChildIds = React33.useRef([]);
  var _React$useState3 = React33.useState(false), childrenCalculated = _React$useState3[0], setChildrenCalculated = _React$useState3[1];
  React33.useEffect(function() {
    var childIds = [];
    React33.Children.forEach(children, function(child) {
      if (React33.isValidElement(child) && child.props.nodeId) {
        childIds.push(child.props.nodeId);
      }
    });
  ...
  return React33.createElement(TreeViewContext_default.Provider, {
    value: {
      icons: {
        defaultCollapseIcon,
        defaultExpandIcon,
  ...
  }, React33.createElement("ul", _extends({
    role: "tree",
...
var TreeView_default = withStyles_default(styles40, {
  name: "MuiTreeView"
})(TreeView);
export {
...
@material-ui/lab/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=@material-ui_lab.js.map
